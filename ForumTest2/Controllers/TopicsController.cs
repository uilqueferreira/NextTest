...
namespace ForumTest2.Controllers
{
    public class TopicsController : Controller
    {
        ...
        {
            ViewBag.Creator = new SelectList(db.ApplicationUsers, "Id", "Email");
            return View();
        }
        ...
        public ActionResult Create([Bind(Include = "Id,Title,Description,Creator,CreationDate")] Topic topic)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Title,Description,Creator,CreationDate")] Topic topic)
        {
            if (ModelState.IsValid)
            {
                topic.CreationDate = DateTime.Now;
